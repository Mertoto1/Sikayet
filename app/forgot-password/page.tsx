        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full p-12 text-white">
          <div className="max-w-md">
            <div className="mb-8">
              ...
              <h1 className="text-4xl font-bold mb-4">Şifremi Unuttum</h1>
              <p className="text-xl text-indigo-100 mb-8">Endişelenmeyin, şifrenizi sıfırlamanıza yardımcı olacağız.</p>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 bg-white/10 backdrop-blur-sm rounded-xl p-4">
                ...
                <div>
                  <h3 className="font-semibold mb-1">E-posta Doğrulama</h3>
                  <p className="text-sm text-indigo-200">E-posta adresinize sıfırlama bağlantısı göndereceğiz</p>
                </div>
              </div>
              <div className="flex items-start gap-3 bg-white/10 backdrop-blur-sm rounded-xl p-4">
                <div className="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <h3 className="font-semibold mb-1">Güvenli İşlem</h3>
                  <p className="text-sm text-indigo-200">Bağlantı sadece 1 saat geçerlidir</p>
                </div>
              </div>
              <div className="flex items-start gap-3 bg-white/10 backdrop-blur-sm rounded-xl p-4">
                <div className="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <h3 className="font-semibold mb-1">Kolay Sıfırlama</h3>
                  <p className="text-sm text-indigo-200">Yeni şifrenizi kolayca oluşturun</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-10">
            {success ? (
              <div className="text-center">
                ...
                <Link 
                  href="/login" 
                  className="inline-block bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-3 px-6 rounded-xl font-semibold hover:from-indigo-700 hover:to-purple-700 transition-all duration-300"
                >
                  Giriş Sayfasına Dön
                </Link>
              </div>
              ...
              <>
                ...
                <div className="mt-6 text-center border-t pt-6">
                  <p className="text-gray-600 mb-3">Şifrenizi hatırladınız mı?</p>
