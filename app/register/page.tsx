        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full p-12 text-white">
          <div className="max-w-md">
            <div className="mb-8">
              ...
              <h1 className="text-4xl font-bold mb-4">Yeni Hesap Oluştur</h1>
              <p className="text-xl text-indigo-100 mb-8">Şikayetlerinizi paylaşmak için hemen kaydolun.</p>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 bg-white/10 backdrop-blur-sm rounded-xl p-4">
                ...
                <div>
                  <h3 className="font-semibold mb-1">Şikayet Paylaşımı</h3>
                  <p className="text-sm text-indigo-200">Şikayetlerinizi kolayca paylaşın ve takip edin</p>
                </div>
              </div>
              <div className="flex items-start gap-3 bg-white/10 backdrop-blur-sm rounded-xl p-4">
                <div className="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <h3 className="font-semibold mb-1">Güvenli Hesap</h3>
              ...
              <div className="flex items-start gap-3 bg-white/10 backdrop-blur-sm rounded-xl p-4">
                ...
                <div>
                  <h3 className="font-semibold mb-1">Hızlı Kayıt</h3>
                  <p className="text-sm text-indigo-200">Birkaç dakika içinde hesabınızı oluşturun</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-10">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Hesabınızı oluşturun ve şikayetlerinizi paylaşmaya başlayın
              </p>
            </div>
            ...
            <div className="mt-6 text-center border-t pt-6">
              <p className="text-gray-600 mb-3">Zaten hesabınız var mı?</p>
            ...
            <div className="mt-4 text-center border-t pt-6">
              <p className="text-gray-600 mb-3">Şirket hesabı mı oluşturmak istiyorsunuz?</p>
              <Link href="/company-register" className="font-semibold text-indigo-600 hover:text-indigo-700 transition">
                Şirket Kaydı
              </Link>
            </div>
          </div>
