...
export default function CompanyLoginPage() {
    ...
    async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        try {
            ...
            // Wait a bit to ensure cookie is set in browser, then redirect
            setTimeout(() => {
                ...
                <div className="relative z-10 flex flex-col justify-center items-center w-full p-12 text-white">
                    <div className="max-w-md">
                        <div className="mb-8">
                            ...
                            <h1 className="text-4xl font-bold mb-4">Şirket Girişi</h1>
                ...
                <div className="w-full max-w-md">
                    <div className="bg-white rounded-2xl shadow-xl p-8 md:p-10">
                        <div className="text-center mb-8">
                            <h2 className="text-3xl font-bold text-gray-900 mb-2">Şirket Girişi</h2>
                            <p className="text-gray-600">
                                Şirket üyesi değil misiniz?{' '}
